...
namespace PaymentPlugins\Vendor\Stripe\Reserve;
 ...
 * @property (object{release_after: null|int, scheduled_release: null|int}&\PaymentPlugins\Vendor\Stripe\StripeObject) $release_schedule
 * @property null|Plan|string $reserve_plan The ReservePlan which produced this ReserveHold (i.e., resplan_123)
 * @property null|string|\PaymentPlugins\Vendor\Stripe\Charge $source_charge The Charge which funded this ReserveHold (e.g., ch_123)
 ...
 */
class Hold extends \PaymentPlugins\Vendor\Stripe\ApiResource
{
