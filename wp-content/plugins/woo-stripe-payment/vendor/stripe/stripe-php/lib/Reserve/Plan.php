 ...
 * @property null|(object{release_after: int, scheduled_release: int}&\PaymentPlugins\Vendor\Stripe\StripeObject) $fixed_release
 ...
 * @property null|(object{days_after_charge: int, expires_on: null|int}&\PaymentPlugins\Vendor\Stripe\StripeObject) $rolling_release
 ...
 */
class Plan extends \PaymentPlugins\Vendor\Stripe\ApiResource
{
