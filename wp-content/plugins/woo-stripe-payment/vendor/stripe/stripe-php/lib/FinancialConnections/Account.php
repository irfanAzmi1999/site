...
namespace PaymentPlugins\Vendor\Stripe\FinancialConnections;
 ...
 * @property null|(object{account?: string|\PaymentPlugins\Vendor\Stripe\Account, customer?: string|\PaymentPlugins\Vendor\Stripe\Customer, customer_account?: string, type: string}&\PaymentPlugins\Vendor\Stripe\StripeObject) $account_holder The account holder that this account belongs to.
 * @property null|((object{expected_expiry_date: null|int, identifier_type: string, status: string, supported_networks: string[]}&\PaymentPlugins\Vendor\Stripe\StripeObject))[] $account_numbers Details about the account numbers.
 * @property null|(object{as_of: int, cash?: (object{available: null|\PaymentPlugins\Vendor\Stripe\StripeObject}&\PaymentPlugins\Vendor\Stripe\StripeObject), credit?: (object{used: null|\PaymentPlugins\Vendor\Stripe\StripeObject}&\PaymentPlugins\Vendor\Stripe\StripeObject), current: \PaymentPlugins\Vendor\Stripe\StripeObject, type: string}&\PaymentPlugins\Vendor\Stripe\StripeObject) $balance The most recent information about the account's balance.
 * @property null|(object{last_attempted_at: int, next_refresh_available_at: null|int, status: string}&\PaymentPlugins\Vendor\Stripe\StripeObject) $balance_refresh The state of the most recent attempt to refresh the account balance.
 ...
 * @property null|(object{last_attempted_at: int, next_refresh_available_at: null|int, status: string}&\PaymentPlugins\Vendor\Stripe\StripeObject) $ownership_refresh The state of the most recent attempt to refresh the account owners.
 ...
 * @property null|(object{id: string, last_attempted_at: int, next_refresh_available_at: null|int, status: string}&\PaymentPlugins\Vendor\Stripe\StripeObject) $transaction_refresh The state of the most recent attempt to refresh the account transactions.
 */
class Account extends \PaymentPlugins\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \PaymentPlugins\Vendor\Stripe\Collection<Account> of ApiResources
     *
     ...
     * @param null|array|string $opts
     *
     * @return \PaymentPlugins\Vendor\Stripe\Collection<AccountOwner> list of account owners
     *
     * @throws \PaymentPlugins\Vendor\Stripe\Exception\ApiErrorException if the request fails
     */
