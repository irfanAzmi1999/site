 ...
 * @property null|(object{account?: string|\PaymentPlugins\Vendor\Stripe\Account, customer?: string|\PaymentPlugins\Vendor\Stripe\Customer, customer_account?: string, type: string}&\PaymentPlugins\Vendor\Stripe\StripeObject) $account_holder The account holder for whom accounts are collected in this session.
 * @property \PaymentPlugins\Vendor\Stripe\Collection<Account> $accounts The accounts that were collected as part of this Session.
 * @property null|string $client_secret A value that will be passed to the client to launch the authentication flow.
 * @property null|(object{account_subcategories: null|string[], countries: null|string[]}&\PaymentPlugins\Vendor\Stripe\StripeObject) $filters
