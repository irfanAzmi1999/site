...
namespace PaymentPlugins\Vendor\Stripe\Climate;
 ...
 * @property null|(object{public_name: string}&\PaymentPlugins\Vendor\Stripe\StripeObject) $beneficiary
 ...
 * @property ((object{delivered_at: int, location: null|(object{city: null|string, country: string, latitude: null|float, longitude: null|float, region: null|string}&\PaymentPlugins\Vendor\Stripe\StripeObject), metric_tons: string, registry_url: null|string, supplier: Supplier}&\PaymentPlugins\Vendor\Stripe\StripeObject))[] $delivery_details Details about the delivery of carbon removal for this order.
 ...
 */
class Order extends \PaymentPlugins\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \PaymentPlugins\Vendor\Stripe\Collection<Order> of ApiResources
     *
     * @throws \PaymentPlugins\Vendor\Stripe\Exception\ApiErrorException if the request fails
     */
