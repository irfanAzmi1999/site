 ...
 * @property (object{card_logo: string, carrier_text: string, second_line: string}&\PaymentPlugins\Vendor\Stripe\StripeObject) $features
 ...
 */
class PhysicalBundle extends \PaymentPlugins\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \PaymentPlugins\Vendor\Stripe\Collection<PhysicalBundle> of ApiResources
     *
