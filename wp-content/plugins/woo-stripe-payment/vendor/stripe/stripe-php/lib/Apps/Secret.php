...
namespace PaymentPlugins\Vendor\Stripe\Apps;
 ...
 * @property (object{type: string, user?: string}&\PaymentPlugins\Vendor\Stripe\StripeObject) $scope
 */
class Secret extends \PaymentPlugins\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \PaymentPlugins\Vendor\Stripe\Collection<Secret> of ApiResources
     *
     * @throws \PaymentPlugins\Vendor\Stripe\Exception\ApiErrorException if the request fails
     */
