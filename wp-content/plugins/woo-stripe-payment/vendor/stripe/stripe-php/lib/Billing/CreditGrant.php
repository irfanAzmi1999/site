 ...
 * @property (object{monetary: null|(object{currency: string, value: int}&\PaymentPlugins\Vendor\Stripe\StripeObject), type: string}&\PaymentPlugins\Vendor\Stripe\StripeObject) $amount
 * @property (object{scope: (object{price_type?: string, prices?: ((object{id: null|string}&\PaymentPlugins\Vendor\Stripe\StripeObject))[]}&\PaymentPlugins\Vendor\Stripe\StripeObject)}&\PaymentPlugins\Vendor\Stripe\StripeObject) $applicability_config
 ...
 * @property string|\PaymentPlugins\Vendor\Stripe\Customer $customer ID of the customer receiving the billing credits.
 ...
 * @property null|string|\PaymentPlugins\Vendor\Stripe\TestHelpers\TestClock $test_clock ID of the test clock this credit grant belongs to.
 ...
 */
class CreditGrant extends \PaymentPlugins\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \PaymentPlugins\Vendor\Stripe\Collection<CreditGrant> of ApiResources
     *
     * @throws \PaymentPlugins\Vendor\Stripe\Exception\ApiErrorException if the request fails
     */
