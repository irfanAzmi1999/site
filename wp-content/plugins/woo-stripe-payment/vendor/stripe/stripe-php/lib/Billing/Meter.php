 ...
 * @property (object{event_payload_key: string, type: string}&\PaymentPlugins\Vendor\Stripe\StripeObject) $customer_mapping
 * @property (object{formula: string}&\PaymentPlugins\Vendor\Stripe\StripeObject) $default_aggregation
 ...
 * @property (object{deactivated_at: null|int}&\PaymentPlugins\Vendor\Stripe\StripeObject) $status_transitions
 * @property int $updated Time at which the object was last updated. Measured in seconds since the Unix epoch.
 * @property (object{event_payload_key: string}&\PaymentPlugins\Vendor\Stripe\StripeObject) $value_settings
 */
class Meter extends \PaymentPlugins\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \PaymentPlugins\Vendor\Stripe\Collection<Meter> of ApiResources
     *
     * @throws \PaymentPlugins\Vendor\Stripe\Exception\ApiErrorException if the request fails
     */
     ...
     * @param null|array|string $opts
     *
     * @return \PaymentPlugins\Vendor\Stripe\Collection<MeterEventSummary> the list of meter event summaries
     *
     * @throws \PaymentPlugins\Vendor\Stripe\Exception\ApiErrorException if the request fails
     */
