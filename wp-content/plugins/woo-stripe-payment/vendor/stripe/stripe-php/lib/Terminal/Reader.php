 ...
 * @property null|(object{collect_inputs?: (object{inputs: ((object{custom_text: null|(object{description: null|string, skip_button: null|string, submit_button: null|string, title: null|string}&\PaymentPlugins\Vendor\Stripe\StripeObject), email?: (object{value: null|string}&\PaymentPlugins\Vendor\Stripe\StripeObject), numeric?: (object{value: null|string}&\PaymentPlugins\Vendor\Stripe\StripeObject), phone?: (object{value: null|string}&\PaymentPlugins\Vendor\Stripe\StripeObject), required: null|bool, selection?: (object{choices: ((object{id: null|string, style: null|string, text: string}&\PaymentPlugins\Vendor\Stripe\StripeObject))[], id: null|string, text: null|string}&\PaymentPlugins\Vendor\Stripe\StripeObject), signature?: (object{value: null|string}&\PaymentPlugins\Vendor\Stripe\StripeObject), skipped?: bool, text?: (object{value: null|string}&\PaymentPlugins\Vendor\Stripe\StripeObject), toggles: null|((object{default_value: null|string, description: null|string, title: null|string, value: null|string}&\PaymentPlugins\Vendor\Stripe\StripeObject))[], type: string}&\PaymentPlugins\Vendor\Stripe\StripeObject))[], metadata: null|\PaymentPlugins\Vendor\Stripe\StripeObject}&\PaymentPlugins\Vendor\Stripe\StripeObject), collect_payment_method?: (object{collect_config?: (object{enable_customer_cancellation?: bool, skip_tipping?: bool, tipping?: (object{amount_eligible?: int}&\PaymentPlugins\Vendor\Stripe\StripeObject)}&\PaymentPlugins\Vendor\Stripe\StripeObject), payment_intent: string|\PaymentPlugins\Vendor\Stripe\PaymentIntent, payment_method?: \PaymentPlugins\Vendor\Stripe\PaymentMethod}&\PaymentPlugins\Vendor\Stripe\StripeObject), confirm_payment_intent?: (object{confirm_config?: (object{return_url?: string}&\PaymentPlugins\Vendor\Stripe\StripeObject), payment_intent: string|\PaymentPlugins\Vendor\Stripe\PaymentIntent}&\PaymentPlugins\Vendor\Stripe\StripeObject), failure_code: null|string, failure_message: null|string, process_payment_intent?: (object{payment_intent: string|\PaymentPlugins\Vendor\Stripe\PaymentIntent, process_config?: (object{enable_customer_cancellation?: bool, return_url?: string, skip_tipping?: bool, tipping?: (object{amount_eligible?: int}&\PaymentPlugins\Vendor\Stripe\StripeObject)}&\PaymentPlugins\Vendor\Stripe\StripeObject)}&\PaymentPlugins\Vendor\Stripe\StripeObject), process_setup_intent?: (object{generated_card?: string, process_config?: (object{enable_customer_cancellation?: bool}&\PaymentPlugins\Vendor\Stripe\StripeObject), setup_intent: string|\PaymentPlugins\Vendor\Stripe\SetupIntent}&\PaymentPlugins\Vendor\Stripe\StripeObject), refund_payment?: (object{amount?: int, charge?: string|\PaymentPlugins\Vendor\Stripe\Charge, metadata?: \PaymentPlugins\Vendor\Stripe\StripeObject, payment_intent?: string|\PaymentPlugins\Vendor\Stripe\PaymentIntent, reason?: string, refund?: string|\PaymentPlugins\Vendor\Stripe\Refund, refund_application_fee?: bool, refund_payment_config?: (object{enable_customer_cancellation?: bool}&\PaymentPlugins\Vendor\Stripe\StripeObject), reverse_transfer?: bool}&\PaymentPlugins\Vendor\Stripe\StripeObject), set_reader_display?: (object{cart: null|(object{currency: string, line_items: (object{amount: int, description: string, quantity: int}&\PaymentPlugins\Vendor\Stripe\StripeObject)[], tax: null|int, total: int}&\PaymentPlugins\Vendor\Stripe\StripeObject), type: string}&\PaymentPlugins\Vendor\Stripe\StripeObject), status: string, type: string}&\PaymentPlugins\Vendor\Stripe\StripeObject) $action The most recent action performed by the reader.
 ...
 */
class Reader extends \PaymentPlugins\Vendor\Stripe\ApiResource
{
     ...
     * @param null|array|string $opts
     *
     * @return \PaymentPlugins\Vendor\Stripe\Collection<Reader> of ApiResources
     *
     * @throws \PaymentPlugins\Vendor\Stripe\Exception\ApiErrorException if the request fails
     */
