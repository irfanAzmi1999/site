 ...
 * @property \PaymentPlugins\Vendor\Stripe\EventData\V1BillingMeterErrorReportTriggeredEventData $data data associated with the event
 */
class V1BillingMeterErrorReportTriggeredEvent extends \PaymentPlugins\Vendor\Stripe\V2\Core\Event
{
     ...
     *
     * @return \PaymentPlugins\Vendor\Stripe\Billing\Meter
     *
    ...
    public static function constructFrom($values, $opts = null, $apiMode = 'v2')
    {
        ...
        if (null !== $evt->data) {
            $evt->data = \PaymentPlugins\Vendor\Stripe\EventData\V1BillingMeterErrorReportTriggeredEventData::constructFrom($evt->data, $opts, $apiMode);
        }
