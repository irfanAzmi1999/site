 ...
 * @property (object{error_count: int, error_types: (object{code: string, error_count: int, sample_errors: (object{error_message: string, request: (object{identifier: string}&\PaymentPlugins\Vendor\Stripe\StripeObject)}&\PaymentPlugins\Vendor\Stripe\StripeObject)[]}&\PaymentPlugins\Vendor\Stripe\StripeObject)[]}&\PaymentPlugins\Vendor\Stripe\StripeObject) $reason This contains information about why meter error happens.
 ...
 */
class V1BillingMeterErrorReportTriggeredEventData extends \PaymentPlugins\Vendor\Stripe\StripeObject {}
