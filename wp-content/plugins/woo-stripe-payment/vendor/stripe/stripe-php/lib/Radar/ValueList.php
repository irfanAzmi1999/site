 ...
 * @property \PaymentPlugins\Vendor\Stripe\Collection<ValueListItem> $list_items List of items contained within this value list.
 ...
 */
class ValueList extends \PaymentPlugins\Vendor\Stripe\ApiResource
{
     ...
     * @param null|array|string $opts
     *
     * @return \PaymentPlugins\Vendor\Stripe\Collection<ValueList> of ApiResources
     *
     * @throws \PaymentPlugins\Vendor\Stripe\Exception\ApiErrorException if the request fails
     */
