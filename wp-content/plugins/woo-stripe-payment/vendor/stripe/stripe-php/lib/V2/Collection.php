...
namespace PaymentPlugins\Vendor\Stripe\V2;
 ...
 */
class Collection extends \PaymentPlugins\Vendor\Stripe\StripeObject implements \Countable, \IteratorAggregate
{
    const OBJECT_NAME = 'list';
    use \PaymentPlugins\Vendor\Stripe\ApiOperations\Request;
    /**
     * @return string the base URL for the given class
     */
    public static function baseUrl()
    {
        return \PaymentPlugins\Vendor\Stripe\Stripe::$apiBase;
    }
    /**
     * @return mixed
     */
    ...
    public function autoPagingIterator()
    {
        ...
        while (true) {
            ...
            $obj = \PaymentPlugins\Vendor\Stripe\Util\Util::convertToStripeObject($response, $opts, 'v2');
