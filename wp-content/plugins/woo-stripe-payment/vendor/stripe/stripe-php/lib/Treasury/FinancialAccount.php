 ...
 * @property (object{cash: \PaymentPlugins\Vendor\Stripe\StripeObject, inbound_pending: \PaymentPlugins\Vendor\Stripe\StripeObject, outbound_pending: \PaymentPlugins\Vendor\Stripe\StripeObject}&\PaymentPlugins\Vendor\Stripe\StripeObject) $balance Balance information for the FinancialAccount
 ...
 * @property ((object{aba?: (object{account_holder_name: string, account_number?: null|string, account_number_last4: string, bank_name: string, routing_number: string}&\PaymentPlugins\Vendor\Stripe\StripeObject), supported_networks?: string[], type: string}&\PaymentPlugins\Vendor\Stripe\StripeObject))[] $financial_addresses The set of credentials that resolve to a FinancialAccount.
 ...
 * @property null|(object{inbound_flows: null|string, outbound_flows: null|string}&\PaymentPlugins\Vendor\Stripe\StripeObject) $platform_restrictions The set of functionalities that the platform can restrict on the FinancialAccount.
 ...
 * @property (object{closed: null|(object{reasons: string[]}&\PaymentPlugins\Vendor\Stripe\StripeObject)}&\PaymentPlugins\Vendor\Stripe\StripeObject) $status_details
 ...
 */
class FinancialAccount extends \PaymentPlugins\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \PaymentPlugins\Vendor\Stripe\Collection<FinancialAccount> of ApiResources
     *
     * @throws \PaymentPlugins\Vendor\Stripe\Exception\ApiErrorException if the request fails
     */
    ...
    public function retrieveFeatures($params = null, $opts = null)
    {
        ...
        $obj = \PaymentPlugins\Vendor\Stripe\Util\Util::convertToStripeObject($response, $opts);
        $obj->setLastResponse($response);
        return $obj;
    }
    /**
