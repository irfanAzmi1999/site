 ...
 * @property (object{balance?: string, billing_details: (object{address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\PaymentPlugins\Vendor\Stripe\StripeObject), email: null|string, name: null|string}&\PaymentPlugins\Vendor\Stripe\StripeObject), financial_account?: (object{id: string, network: string}&\PaymentPlugins\Vendor\Stripe\StripeObject), issuing_card?: string, type: string, us_bank_account?: (object{bank_name: null|string, last4: null|string, routing_number: null|string}&\PaymentPlugins\Vendor\Stripe\StripeObject)}&\PaymentPlugins\Vendor\Stripe\StripeObject) $initiating_payment_method_details
 * @property (object{credit_reversal: null|string, issuing_authorization: null|string, issuing_transaction: null|string, source_flow: null|string, source_flow_details?: null|(object{credit_reversal?: CreditReversal, outbound_payment?: OutboundPayment, outbound_transfer?: OutboundTransfer, payout?: \PaymentPlugins\Vendor\Stripe\Payout, type: string}&\PaymentPlugins\Vendor\Stripe\StripeObject), source_flow_type: null|string}&\PaymentPlugins\Vendor\Stripe\StripeObject) $linked_flows
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property string $network The rails used to send the funds.
 * @property null|(object{deadline: null|int, restricted_reason: null|string}&\PaymentPlugins\Vendor\Stripe\StripeObject) $reversal_details Details describing when a ReceivedCredit may be reversed.
 ...
 */
class ReceivedCredit extends \PaymentPlugins\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \PaymentPlugins\Vendor\Stripe\Collection<ReceivedCredit> of ApiResources
     *
