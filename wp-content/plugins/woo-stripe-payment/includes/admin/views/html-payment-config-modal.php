    ...
    <div class="wc-backbone-modal">
        <div class="wc-backbone-modal-content">
            <section class="wc-backbone-modal-main" role="main">
                ...
                <article>
                    <form id="wc-stripe-pay-order-form">
                        ...
                        <div class="modal-wide option">
                            ...
                            <input type="text" id="payment_config_name" name="payment_config_name"
                                   class="input-text regular-input" value="<?php echo esc_attr( $name ) ?>"
                                   style="width: 100%"/>
                        </div>
                    </form>
                </article>
                <footer>
                    <div class="inner">
                        <button id="create-payment-config"
                                class="button button-primary button-large"><?php esc_html_e( 'Create', 'woo-stripe-payment' ); ?></button>
                    </div>
                </footer>
            </section>
        </div>
