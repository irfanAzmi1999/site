        ...
        <fieldset>
            ...
            <div class="wc-stripe-fee-container">
                <div class="wc-stripe-fee-col">
                    <label><?php esc_html_e( 'Type', 'woo-stripe-payment' ); ?></label> <select
                            class="select wc-enhanced-select ach-fee" name="<?php echo esc_attr( $field_key ); ?>[type]"
                ...
                <div class="wc-stripe-fee-col">
                    <label><?php esc_html_e( 'Value', 'woo-stripe-payment' ); ?></label> <input
                            class="input-text regular-input <?php echo esc_attr( $data['class'] ); ?>" type="text"
                            name="<?php echo esc_attr( $field_key ); ?>[value]"
                            id="<?php echo esc_attr( $field_key ); ?>[value]"
                            style="<?php echo esc_attr( $data['css'] ); ?>"
                            value="<?php echo esc_attr( $this->get_option( $key )['value'] ); ?>"
