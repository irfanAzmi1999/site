...
<div id="wc_stripe_local_payment_<?php echo esc_attr( $gateway->id ) ?>" data-active="<?php echo esc_attr( $gateway->is_local_payment_available() ) ?>">
    <ol>
        ...
        <li><?php printf( esc_html__( 'Enter the code into the input fields below. Click %1$s once you have entered the code.', 'woo-stripe-payment' ), '<b>' . esc_attr( $gateway->order_button_text ) . '</b>' ) ?></li>
