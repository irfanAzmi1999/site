...
if ( ! class_exists( 'ReviewPublished' ) ) :

	/**
	 * ReviewPublished
	 *
	 * @category ReviewPublished
	 * @package  SureTriggers
	...
	class ReviewPublished {
		 ...
		 * @var string
		 */
		public $trigger = 'directories_pro_review_published';
		...
		public function register( $triggers ) {
			$triggers[ $this->integration ][ $this->trigger ] = [
				'label'         => __( 'Review Published', 'suretriggers' ),
				'action'        => $this->trigger,
