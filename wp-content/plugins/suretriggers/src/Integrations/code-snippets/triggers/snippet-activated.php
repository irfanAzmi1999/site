<?php
/**
 * CodeSnippetsSnippetActivated.
 * php version 5.6
 *
 * @category CodeSnippetsSnippetActivated
...
if ( ! class_exists( 'CodeSnippetsSnippetActivated' ) ) :
	 ...
	 */
	class CodeSnippetsSnippetActivated {
		 ...
		 * @var string
		 */
		public $trigger = 'code_snippets_snippet_activated';
		...
		public function register( $triggers ) {
			...
			$triggers[ $this->integration ][ $this->trigger ] = [
				'label'         => __( 'Snippet Activated', 'suretriggers' ),
				'action'        => $this->trigger,
				'common_action' => 'code_snippets/activate_snippet',
	 ...
	 */
	CodeSnippetsSnippetActivated::get_instance();
