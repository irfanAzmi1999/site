<?php
/**
 * OptionsScfFieldUpdated.
 * php version 5.6
 *
 * @category OptionsScfFieldUpdated
...
if ( ! class_exists( 'OptionsScfFieldUpdated' ) ) :
	...
	class OptionsScfFieldUpdated {
		 ...
		 * @var string
		 */
		public $trigger = 'options_scf_field_updated';
	 ...
	 */
	OptionsScfFieldUpdated::get_instance();
