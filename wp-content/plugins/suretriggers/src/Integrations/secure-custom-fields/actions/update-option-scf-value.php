<?php
/**
 * UpdateOptionScfValue.
 * php version 5.6
 *
 * @category UpdateOptionScfValue
 ...
 * @since    1.0.0
 */
class UpdateOptionScfValue extends AutomateAction {
	 ...
	 * @var string
	 */
	public $action = 'update_option_scf_value';
	...
	public function _action_listener( $user_id, $automation_id, $fields, $selected_options ) {
		...
		if ( ! function_exists( 'update_field' ) || ! function_exists( 'get_field' ) ) {
			throw new Exception( 'Secure Custom Fields update_field() function not found.' );
		}
...
UpdateOptionScfValue::get_instance();
