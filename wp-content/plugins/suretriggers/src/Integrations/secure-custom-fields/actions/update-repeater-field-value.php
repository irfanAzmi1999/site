<?php
/**
 * UpdateScfRepeaterFieldValue.
 * php version 5.6
 *
 * @category UpdateScfRepeaterFieldValue
...
namespace SureTriggers\Integrations\SecureCustomFields\Actions;
 ...
 * @since    1.0.0
 */
class UpdateScfRepeaterFieldValue extends AutomateAction {
	 ...
	 * @var string
	 */
	public $action = 'update_repeater_field_scf_value';
	...
	public function _action_listener( $user_id, $automation_id, $fields, $selected_options ) {
		...
		if ( ! function_exists( 'add_row' ) || ! function_exists( 'get_field' ) ) {
			throw new Exception( 'Secure Custom Fields get_field() function not found.' );
		}
...
UpdateScfRepeaterFieldValue::get_instance();
