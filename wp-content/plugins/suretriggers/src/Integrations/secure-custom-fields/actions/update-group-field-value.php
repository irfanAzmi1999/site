<?php
/**
 * UpdateScfGroupFieldValue.
 * php version 5.6
 *
 * @category UpdateScfGroupFieldValue
 ...
 * @since    1.0.0
 */
class UpdateScfGroupFieldValue extends AutomateAction {
	 ...
	 * @var string
	 */
	public $action = 'update_group_field_scf_value';
...
UpdateScfGroupFieldValue::get_instance();
