...
if ( ! class_exists( 'EE_RegistrationApproved' ) ) :

	/**
	 * EE_RegistrationApproved
	 *
	 * @psalm-suppress UndefinedTrait
	 */
	class EE_RegistrationApproved {
		 ...
		 * @var string
		 */
		public $trigger = 'ee_registration_approved';
		...
		public function register( $triggers ) {
			...
			$triggers[ $this->integration ][ $this->trigger ] = [
				'label'         => __( 'Registration Approved', 'suretriggers' ),
				'action'        => $this->trigger,
				'common_action' => 'AHEE__EE_Registration__set_status__to_approved',
	 ...
	 */
	EE_RegistrationApproved::get_instance();
