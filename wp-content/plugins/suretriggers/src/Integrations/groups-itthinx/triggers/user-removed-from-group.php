<?php
/**
 * UserRemovedFromGroupItthinx.
 * php version 5.6
 *
 * @category UserRemovedFromGroupItthinx
...
if ( ! class_exists( 'UserRemovedFromGroupItthinx' ) ) :
	 ...
	 */
	class UserRemovedFromGroupItthinx {
		 ...
		 * @var string
		 */
		public $trigger = 'groups_itthinx_user_removed_from_group';
		...
		public function register( $triggers ) {
			$triggers[ $this->integration ][ $this->trigger ] = [
				...
				'action'        => $this->trigger,
				'common_action' => 'groups_deleted_user_group',
	 ...
	 */
	UserRemovedFromGroupItthinx::get_instance();
