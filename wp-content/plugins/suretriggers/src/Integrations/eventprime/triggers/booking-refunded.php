...
if ( ! class_exists( 'BookingRefunded' ) ) :
	...
	class BookingRefunded {
		 ...
		 * @var string
		 */
		public $trigger = 'ep_event_booking_refunded';
		...
		public function register( $triggers ) {
			...
			$triggers[ $this->integration ][ $this->trigger ] = [
				'label'         => __( 'Booking Refunded', 'suretriggers' ),
				'action'        => $this->trigger,
				'common_action' => 'ep_booking_refunded',
