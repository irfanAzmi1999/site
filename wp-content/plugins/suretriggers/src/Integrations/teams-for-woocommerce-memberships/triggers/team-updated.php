...
if ( ! class_exists( 'TeamUpdated' ) ) :
	...
	class TeamUpdated {
		 ...
		 * @var string
		 */
		public $trigger = 'wc_teams_team_updated';
		...
		public function register( $triggers ) {
			$triggers[ $this->integration ][ $this->trigger ] = [
				'label'         => __( 'A team is updated', 'suretriggers' ),
				'action'        => $this->trigger,
				'common_action' => 'wc_memberships_for_teams_team_saved',
