...
👉 [Try the live demo of OttoKit](https://zipwp.org/plugins/suretriggers/)
...
OttoKit is our way to make sure that businesses, like Jane, can connect their favorite apps, automate mundane tasks, and focus on what truly matters — discover new growth opportunities  📈🙂
...
And if you are a developer, and would like to integrate your plugin or app — we have robust APIs which make it extremely easy to integrate any WordPress plugin or application with OttoKit.

[Please get in touch with us](https://ottokit.com/contact-us/) and we would be happy to help.

## BRANDING GUIDELINE ##

OttoKit® is a registered trademark. Please use the following format when mentioning the OttoKit anywhere.
...
* Fix: "FluentBoards" – Fixed "Create Task"/"Create Board" Actions failing on FluentBoards v2.0.4+
* Fix: This update addressed multiple security hardening issues, including SSRF protection improvements, an unauthenticated object-injection fix, and role/privilege-escalation safeguards across several integrations
...
* Improvement: "WooCommerce Subscriptions" – Added new "Find Subscription by Subscription ID" Action

= Version 1.1.32 - Thursday, 2nd July 2026 =
* New: Added "SureDonation" Integration
* Improvement: "Bricks Builder" – Added new "User Account Activated" Trigger
* Improvement: "FluentCRM" – Added slug sanitization to the "Create Tag" Action
...
* New: Added "Code Snippets" Integration
* New: Added "Everest Forms" Integration
* Improvement: "SureDash" – Added new Actions
* Improvement: "StoreEngine" – Added product selection support to the "Product Purchased" Trigger
...
* Improvement: "Fluent Booking" – Added new Actions
* Improvement: "RafflePress" – Added new "Add Contact to Contest" Action
* Improvement: "FluentCommunity" – Added new Actions
* Improvement: "Amelia" – Added new "Create Coupon" Action
* New: Added "Jet Appointments Booking" Integration
